...
export const categories: Category[] = [
  {
    ...
    entities: [
      ...
      { id: 11, name: "Banco Itaú", domain: "itau.com.ar" },
      ...
      { id: 15, name: "HSBC Argentina", domain: "hsbc.com.ar" },
      { id: 16, name: "Banco Piano", domain: "bancopiano.com.ar" },
      { id: 17, name: "Banco de Corrientes (BANCOR)", domain: "bancor.com.ar" },
      { id: 18, name: "Banco de La Pampa", domain: "bancopampa.com.ar" },
      { id: 19, name: "Banco del Chubut", domain: "bancodelchubut.com.ar" },
      { id: 20, name: "Nuevo Banco de Santa Fe", domain: "nbsf.com.ar" },
    ],
  },
  {
    id: "fintechs",
    ...
    entities: [
      ...
      { id: 29, name: "DolarApp", domain: "dolarapp.com" },
  ...
  },
  {
    ...
    entities: [
      ...
      { id: 48, name: "Banco Mariva (ALyC)", domain: "mariva.com.ar" },
      { id: 49, name: "SBS Trading", domain: "sbstrading.com.ar" },
      { id: 50, name: "Álvarez y Compañía", domain: "alvarez.com.ar" },
    ],
  },
]
