...
export const categories: Category[] = [
  {
    ...
    entities: [
      ...
      { id: 345, name: "Banco Itaú Argentina", domain: "itau.com.ar" },
      { id: 346, name: "Banco Credicoop", domain: "credicoop.coop" },
      { id: 347, name: "HSBC Argentina", domain: "hsbc.com.ar" },
      { id: 348, name: "Banco del Tucumán", domain: "btucuman.gob.ar" },
      { id: 349, name: "Banco de Corrientes", domain: "bancocorrientes.gob.ar" },
  ...
  },
  {
    ...
    entities: [
      ...
      { id: 353, name: "Ram", domain: "ramtrucks.com.ar" },
      { id: 354, name: "Land Rover", domain: "landrover.com.ar" },
      { id: 355, name: "Dodge", domain: "dodge.com.ar" },
      { id: 356, name: "Subaru", domain: "subaru.com.ar" },
      { id: 357, name: "Great Wall Motors", domain: "gwmargentina.com.ar" },
  ...
  },
  {
    ...
    entities: [
      ...
      { id: 311, name: "PepsiCo", domain: "pepsico.com.ar" },
      { id: 312, name: "Heineken", domain: "heineken.com.ar" },
      { id: 313, name: "Stella Artois", domain: "stellartois.com" },
      { id: 314, name: "Cerveza Corona", domain: "cervecacorona.com.ar" },
      { id: 315, name: "Brahma", domain: "brahma.com.ar" },
      { id: 316, name: "Ilolay", domain: "ilolay.com.ar" },
      { id: 317, name: "SanCor", domain: "sancor.com.ar" },
      { id: 318, name: "Danone", domain: "danone.com.ar" },
  ...
  },
  {
    ...
    entities: [
      ...
      { id: 335, name: "Tommy Hilfiger", domain: "tommy.com.ar" },
    ],
  },
  {
    id: "gastronomia",
